          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-emerald-600/10 rounded-2xl flex items-center justify-center border border-emerald-600/20 shrink-0">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-700 hover:bg-emerald-600 text-white font-bold transition-all shadow-lg shadow-emerald-500/20 active:scale-95 shrink-0"
            >
              <Plus size={18} />
              요청사항 작성
            </button>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-3 md:mb-0">
                      ...
                      {req.comments && req.comments.length > 0 ? (
                        <div className="flex items-center gap-1 text-amber-400 text-xs font-bold bg-emerald-600/10 px-2 py-1 rounded-md">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-emerald-600 transition-colors"
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-emerald-600 resize-none transition-colors"
              ...
              <div className="p-0 overflow-y-auto flex flex-col md:flex-row">
                  ...
                  <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                    ...
                    {isMaster && (
                      <select 
                        ...
                        className="bg-black/40 border border-white/10 text-white text-sm rounded-xl px-4 py-2 focus:outline-none focus:border-emerald-600"
                      >
                ...
                <div className="p-6 md:w-2/5 flex flex-col bg-black/20">
                  <h3 className="font-bold text-white mb-4 flex items-center gap-2">
                    ...
                    댓글 <span className="text-amber-400">{selectedRequest.comments?.length || 0}</span>
                  </h3>
                  ...
                  <form onSubmit={handleComment} className="mt-auto shrink-0 relative">
                    <textarea 
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white focus:outline-none focus:border-emerald-600 resize-none pr-12"
                      rows={2}
                      required
                    />
                    <button 
                      ...
                      className="absolute right-2 bottom-2 p-1.5 bg-emerald-700 hover:bg-emerald-600 text-white rounded-lg disabled:opacity-50 transition-colors"
                    >
