    ...
    <DashboardLayout>
      <div className="p-8 max-w-7xl mx-auto h-full overflow-y-auto">
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="bg-white/5/5 border border-white/10 rounded-2xl p-5 min-w-[280px]">
            ...
            <button 
              ...
              className={`px-4 py-2 rounded-full text-sm font-bold shadow-lg transition-all whitespace-nowrap ${
                selectedCategory === category
                  ...
                  : "bg-white/5/5 text-white/60 hover:bg-white/5/10 hover:text-white"
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredVideos.map((video, idx) => (
            <motion.div
              ...
              className="group cursor-pointer bg-white/5/5 rounded-2xl overflow-hidden border border-white/10 hover:border-emerald-600/50 hover:bg-white/5/10 transition-all shadow-xl"
              onClick={() => {
          ...
          >
            ...
            >
              <div className="flex items-center justify-between p-4 border-b border-white/10 bg-black/20">
                ...
                <button 
                  onClick={handleCloseVideo}
                  className="p-2 bg-white/5/5 hover:bg-white/5/10 text-white/70 hover:text-white rounded-xl transition-colors"
                >
                  <X size={20} />
                </button>
              </div>
              <div className="aspect-video bg-black w-full relative">
                {showQuiz && selectedVideo.options && (
                  <div className="absolute inset-0 z-50 bg-[#031C13] flex flex-col items-center justify-center p-8 animate-in fade-in duration-300">
                    <div className="max-w-2xl w-full bg-white/5/5 border border-white/10 p-8 rounded-3xl backdrop-blur-sm">
                      ...
                      <div className="space-y-3">
                        {selectedVideo.options.map((option: string, i: number) => (
                          <button
                            ...
                            className={`w-full p-4 rounded-xl border text-left font-bold transition-all ${quizAnswer === i ? 'bg-emerald-700 border-emerald-600 text-white shadow-lg shadow-emerald-500/20' : 'bg-white/5/5 border-white/10 text-white/70 hover:bg-white/5/10 hover:border-white/20'}`}
                          >
                      ...
                      <div className="mt-8 flex justify-center">
                        <button
                          ...
                          className="px-8 py-4 bg-emerald-700 hover:bg-emerald-600 disabled:bg-white/5/10 disabled:text-white/30 text-white rounded-xl font-black text-lg transition-all"
                        >
