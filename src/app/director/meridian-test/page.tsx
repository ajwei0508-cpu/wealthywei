      ...
      <div className="p-8 max-w-7xl mx-auto min-h-[calc(100vh-4rem)] flex flex-col">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">수양명경락검사 설명</h1>
          </div>
          <p className="text-white/50 pl-15">환자에게 검사 결과와 의미를 쉽고 명확하게 설명하는 가이드 영상입니다.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10 flex-1">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden bg-black aspect-[9/16] shadow-2xl border border-white/10">
              <iframe
          ...
          >
            <div className="bg-white/5 rounded-3xl p-8 shadow-sm border border-white/5 flex-1">
