...
export default function TreatmentPage() {
  ...
  return (
    <DashboardLayout>
      <div className="min-h-screen bg-[#042418] text-white">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pt-28">
          ...
          <div className="mb-12">
            ...
            >
              <span className="px-4 py-1.5 rounded-full bg-emerald-600/10 border border-emerald-600/20 text-amber-400 text-[10px] font-black uppercase tracking-[0.2em]">
          ...
          <motion.div 
            ...
            className="relative group rounded-[3rem] overflow-hidden bg-black border border-white/10 shadow-2xl shadow-emerald-500/10"
          >
            ...
            <div className="p-8 md:p-12 bg-gradient-to-t from-black via-black/80 to-transparent flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                <div className="h-16 w-16 rounded-2xl bg-emerald-600/10 flex items-center justify-center text-amber-400 border border-emerald-600/20">
                  <Stethoscope size={32} />
                </div>
                <div>
              ...
              {canDownload && (
                <div className="flex items-center gap-3">
                  <button 
                    ...
                    className="px-8 py-4 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-black text-sm transition-all shadow-lg shadow-emerald-500/20 active:scale-95"
                  >
                    강의자료 다운로드
                  </button>
                </div>
