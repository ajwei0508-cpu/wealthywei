      ...
      <div className="min-h-screen bg-[#042418] text-white font-sans selection:bg-amber-500/30">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-8">
            <button 
              onClick={() => router.push("/")} 
              className="text-white/50 hover:text-amber-400 flex items-center gap-2 text-sm transition-all group"
            >
          ...
          {!isMock && (
            <div className="flex flex-wrap gap-4 mb-8">
              ...
              {!displayData.hasFinancialData || !displayData.hasTreatmentData ? (
                <p className="text-white/50 text-[10px] font-medium flex items-center gap-2 animate-pulse">
            ...
            <div className="relative group overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#1F1D1A] to-[#0D1117] border border-amber-500/30 shadow-2xl p-10">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div>
                  ...
                  <p className="text-white/50 text-sm">동의보감 시스템에서 집계된 전체 발생 매출입니다.</p>
                </div>
                ...
                return finalTrendMonths.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[9px] font-black transition-colors whitespace-nowrap ${selectedMonth === m ? "text-amber-500" : "text-white/70"}`}>
                        {m.split("-")[1]}월
                      </span>
                    </div>
                  );
            ...
            <div className="bg-[#0A3D2A] rounded-[2rem] p-6 border border-white/5 hover:border-amber-500/30 transition-all group shadow-xl">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-sm font-bold text-white/40">{formatNumber(pData.totalRevenue)}</span>
                </div>
                <div className="flex justify-between items-end">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-amber-900 scrollbar-track-transparent">
                       {others.map(([name, count]) => (
                         <div key={name} className="flex flex-col p-3 bg-white/5/[0.02] rounded-xl border border-white/5 hover:border-amber-900 transition-colors">
