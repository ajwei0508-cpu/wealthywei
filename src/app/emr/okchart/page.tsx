...
export default function OkchartPage() {
  ...
  const handleDeleteSelected = async () => {
    console.log(`[OkchartPage] Attempting to delete ${selectedMonthsForDelete.length} months`);
  ...
  const handleDeleteAll = async () => {
    ...
    console.log("[OkchartPage] Attempting to delete ALL data");
              ...
              <div className="flex items-center gap-2 relative">
                {pendingDelete?.type === "single" && pendingDelete.id === selectedMonth ? (
                  <div className="flex items-center gap-2 animate-in fade-in zoom-in duration-200">
                    <button
                      onClick={() => {
                        console.log(`[OkchartPage] Confirmed reset for ${selectedMonth}`);
                  ...
                  <button
                    onClick={() => { 
                      console.log(`[OkchartPage] Reset button clicked for ${selectedMonth}`);
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              {!isManageMode ? (
                <button 
                  onClick={() => {
                    console.log("[OkchartPage] Entering Data Management Mode");
