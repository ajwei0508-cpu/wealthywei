        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-24">
          ...
          <div className="mb-12">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-[#0A2213] border border-white/5 rounded-[2.5rem] p-8 shadow-2xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="p-6 bg-white/5/[0.02] rounded-3xl border border-white/5">
            ...
            <section className="mb-12">
              <DailyMissionCard data={currentEntry as any || { patientMetrics: { new: 0, auto: 0, total: 0, dailyAvg: 0 }, generatedRevenue: { total: 0, nonCovered: 0 }, leakage: { receivables: 0 } }} userName="원장" emrType="hanisarang" />
            </section>
